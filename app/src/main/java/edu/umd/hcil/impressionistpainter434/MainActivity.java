...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickSetSymmetry(View v) {
        PopupMenu popupMenu = new PopupMenu(this, v);
        popupMenu.setOnMenuItemClickListener(this);
        popupMenu.inflate(R.menu.menu_symmetry);
        popupMenu.show();
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuCircleSplatter:
                ...
                return true;
            case R.id.menuNoSymmetry:
                Toast.makeText(this, "No Symmetry", Toast.LENGTH_SHORT).show();
                _impressionistView.setSymmetry(0);
                return true;
            case R.id.menuHorizontal:
                Toast.makeText(this, "Horizontal Symmetry", Toast.LENGTH_SHORT).show();
                _impressionistView.setSymmetry(1);
                return true;
            case R.id.menuVertical:
                Toast.makeText(this, "Vertical Symmetry", Toast.LENGTH_SHORT).show();
                _impressionistView.setSymmetry(2);
                return true;
            case R.id.menuRadial:
                Toast.makeText(this, "Radial Symmetry", Toast.LENGTH_SHORT).show();
                _impressionistView.setSymmetry(3);
                return true;
        }
        return false;
    }
